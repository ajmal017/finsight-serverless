...
public class StatsTest {
    ...
    public static Collection<Object[]> data() {
        ...
        averages.add(new Metric(refDate.plusDays(1), BigDecimal.valueOf(1.5)));
        averages.add(new Metric(refDate.plusDays(2), BigDecimal.valueOf(2.5)));
        ...
        averages.add(new Metric(refDate.plusDays(2), BigDecimal.valueOf(2)));
