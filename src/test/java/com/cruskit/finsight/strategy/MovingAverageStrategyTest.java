...
public class MovingAverageStrategyTest {
    ...
    @Test
    public void testMovingAverageCalculationResultsWithStartDate() {
        ...
        List<Metric> metric = Arrays.asList(
                ...
                new Metric(refDate.plusDays(1), BigDecimal.valueOf(2)),
                new Metric(refDate.plusDays(2), BigDecimal.valueOf(1)),
                new Metric(refDate.plusDays(3), BigDecimal.valueOf(4)), // buy - before start date
                new Metric(refDate.plusDays(4), BigDecimal.valueOf(1)),
                new Metric(refDate.plusDays(5), BigDecimal.valueOf(4)), // sell
                new Metric(refDate.plusDays(6), BigDecimal.valueOf(1)), // buy
                new Metric(refDate.plusDays(7), BigDecimal.valueOf(4)), // sell
        ...
        MovingAverageStrategy mas = new MovingAverageStrategy();
        List<Action> actions = mas.calculateMovingAverageTransactionDates(2,3,metric,refDate.plusDays(4));

        Action[] expectedActions = new Action[4];
        expectedActions[0] = new Action(Action.SELL, refDate.plusDays(5));
        expectedActions[1] = new Action(Action.BUY, refDate.plusDays(6));
        expectedActions[2] = new Action(Action.SELL, refDate.plusDays(7));
        expectedActions[3] = new Action(Action.BUY, refDate.plusDays(8));
